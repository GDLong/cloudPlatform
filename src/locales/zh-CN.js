export default {
  ...
  // 'menu.systemSetting.rightsmanage': '权限管理',
  // // 设备管理
  // 'menu.equimanage': '设备管理',
  // 'menu.equimanage.equilist':'设备列表',
  // // 应用管理
  // 'menu.appmanage': '应用管理',
  // 'menu.appmanage.applist': '应用列表',
  // // obd管理
  // 'menu.obdmanage':"OBD管理",
  // 'menu.obdmanage.obdlist':"OBD列表",
  // 'menu.obdmanage.warnList':"报警列表",
  // //
