export default {
  ...
  // 设备管理
  'menu.equimanage': 'Equipment Management',
  'menu.equimanage.equilist': 'Equipment List',
  // 应用管理
  'menu.appmanage': 'Application Management',
  'menu.appmanage.applist': 'Application List',
  // obd管理
  'menu.obdmanage': 'OBD Management',
  'menu.obdmanage.obdlist': 'OBD List',
  //
